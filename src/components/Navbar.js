        ...
        return(
           <div className="navbarleftdiv" >
               <ul>
                    ...
                    <span><i className="fas fa-home fa-lg"></i></span>Home
                    </li>
                    </a>
                    <a href="/">
                    <li className="navbarlistitem" >
                    <span><i className="far fa-bell"></i></span>Notifications
                    </li>
                    </a>
                    <a href="/">
                    <li className="navbarlistitem" >
                    <span><i className="far fa-envelope"></i></span>Messages
                    </li>
                    </a> 
               </ul>
           </div>
        ...
        return(
            <div className="navbarrightdiv">
                <ul className="parent">
                    ...
                    <li><Avatar id="navbaravatar" 
                    src="https://pbs.twimg.com/profile_images/929275988248104960/aiZt2ho4_bigger.jpg" />
                        <ul id="navbaravatardropmenu">
                            <li><h3>Nihal Kaul</h3></li>
                            <li>@nihal9ns</li>
                            <hr/>
                            <li><i className="far fa-user"></i>Profile</li>
                            <li><i className="far fa-list-alt"></i>Lists</li>
                            <li><i className="fas fa-bolt"></i>Moments</li>
                            <hr/>
                            <li><i className="fas fa-chart-line"></i>Twitter Ads</li>
                            <li><i className="far fa-chart-bar"></i>Analytics</li>
                            <hr/>
                            ...
                            <li>Log out</li>
                            <hr/>
                            <li>Night mode<i className="far fa-moon"></i></li>
                        </ul>
                    </li>
                    <li><button type="text" onClick={this.handleOpen} ><h2>Tweet</h2></button></li>
                </ul>   
                ...
                <Dialog
                    ...
                    >
                    <textarea type="text" placeholder="What's happening?" id="popupdialogtextarea" />
                    </Dialog>
            </div>
        );
    }
        ...
        render(){
            return (
                <div>
                    ...
                    title={<NavbarLeft/>} children={<NavbarRight plc={this.props.plc} />}/>    
                </div>
            );
        }
    }