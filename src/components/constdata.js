...
export const profcard = {
  mypro: {
    ...
    bgimg: "",
    avaimg:
      "https://pbs.twimg.com/profile_images/929275988248104960/aiZt2ho4_bigger.jpg",
    name: "Nihal Kaul",
    twthandle: "@nihal9ns",
    twt: "9",
    flwing: "116",
...
export const actbtn = [
  ...
  <FlatButton
    ...
    title="Location"
  />,
  <FlatButton disabled={true} disableTouchRipple={true} children=" " />
];
...
export const tweetdata = {
  user1: {
    avatar:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSQGlFgOPs3E91MIG6PuyuK6N0ybwKhLlaIMdImR5TStgk5z93fAg",
    title: "Shirley Setia",
  ...
  user2: {
    avatar:
      "https://pbs.twimg.com/profile_images/789817267567472640/BlpcUEvx_bigger.jpg",
    title: "Virat Kohli",
    twthandle: "@imVkohli",
    twt: "1430",
    flwing: "52",
  ...
  user3: {
    avatar:
      "https://pbs.twimg.com/profile_images/1080392405134667778/l4LIh_7L_200x200.jpg",
    title: "Hasura",
    twthandle: "@HasuraHQ",
    twt: "1203",
    flwing: "252",
    flwers: "1452",
    subtitle:
      "Git push and deploy a rust-rocket app to an HTTPS domain with no setup or configuration!🚀💪",
  ...
  user4: {
    ...
    flwing: "436",
    flwers: "9163",
    subtitle: `If it were spelled Javascript (lowercase S)… Then the JSON object would be named JON. #ItsSpelledJavaScript`,
    imgsrc: "https://pbs.twimg.com/media/D3a0wd4WsAAD3PN?format=png&name=small",
    replies: "283",
    retweets: "289",
    likes: "14K"
  }
...
export const suggest = {
  user1: {
    avatar:
      "https://pbs.twimg.com/profile_images/915202136740315137/NGe0Ok-d_400x400.jpg",
    name: "Anushka Sharma",
    twthandle: "@AnushkaSharma"
  },
  user2: {
    avatar:
      "https://pbs.twimg.com/profile_images/661679664/keep_it_onn_bigger.jpg",
    name: "Shah Rukh Khan",
    twthandle: "@iamsrk"
  },
  user3: {
    avatar:
      "https://pbs.twimg.com/profile_images/1110862334346448898/LjUEWPv__200x200.jpg",
    name: "Hrithik Roshan",
    twthandle: "@iHrithik"
  },
  user4: {
    avatar:
      "https://pbs.twimg.com/profile_images/932288112910389248/IsKVxzqN_400x400.jpg",
    name: "Johnny Depp",
    twthandle: "@realDepp"
  },
  user5: {
    avatar:
      "https://pbs.twimg.com/profile_images/741703039355064320/ClVbjlG-_bigger.jpg",
    name: "Ryan Reynolds",
...
export const searchtwt = {
  user1: {
    avatar:
      "https://pbs.twimg.com/profile_images/670707650783412225/pYEQJT3E_400x400.jpg",
    title: "Parmindar",
  ...
  user2: {
    avatar:
      "https://pbs.twimg.com/profile_images/869201850217713668/5lUcaV84_bigger.jpg",
  ...
  user3: {
    avatar:
      "https://pbs.twimg.com/profile_images/1195554309/FE-for-Facebook_bigger.jpg",
  ...
  user4: {
    avatar:
      "https://pbs.twimg.com/profile_images/891033451599507456/_pnMMcAc_bigger.jpg",
    title: "KhaaliJeb",
    subtitle:
