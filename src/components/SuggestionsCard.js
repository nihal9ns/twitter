        ...
        <Paper zDepth={1}>
          <List>
            ...
            <SuggestionsItems
              src={sug.u1.avatar}
              name={sug.u1.name}
              twthandle={sug.u1.twthandle}
            />

            <SuggestionsItems
              src={sug.u2.avatar}
              name={sug.u2.name}
              twthandle={sug.u2.twthandle}
            />

            <SuggestionsItems
              src={sug.u3.avatar}
              name={sug.u3.name}
              twthandle={sug.u3.twthandle}
            />

            <SuggestionsItems
              src={sug.u4.avatar}
              name={sug.u4.name}
              twthandle={sug.u4.twthandle}
            />

            <SuggestionsItems
              src={sug.u5.avatar}
              name={sug.u5.name}
              twthandle={sug.u5.twthandle}
            />
  ...
  render() {
    return (
      <div className={this.props.class}>
        <Paper>
          <div id="twthelplinks">
            &copy; 2017 Twitter <a href="/">About</a>{" "}
            <a href="/">Help Center</a> <a href="/">Terms</a>{" "}
            <a href="/">Privacy policy</a>
            &nbsp;<a href="/">Cookies</a> <a href="/">Ads info</a>{" "}
            <a href="/">Brand</a> <a href="/">Blog</a> <a href="/">Status</a>
            &nbsp;<a href="/">Apps</a> <a href="/">Jobs</a>{" "}
            <a href="/">Marketing</a> <a href="/">Business</a>{" "}
            <a href="/">Developers</a>
          </div>
        </Paper>
      </div>
