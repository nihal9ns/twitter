  ...
  render() {
    return (
      <Card>
        ...
        >
          <ProfileCard
            className={this.props.dispornodisp}
            bgimg={this.props.bgimg}
            avaimg={this.props.avatar}
            name={this.props.title}
            twthandle={this.props.twthandle}
            twt={this.props.twt}
            flwing={this.props.flwing}
            flwers={this.props.flwers}
          />
        </CardHeader>
        <List
          expandable={true}
    ...
    return (
      <div className="timelinediv">
        <Paper className="timelinepaper" rounded={false} zDepth={0}>
          <div className="user">
            <Tweets
              dispornodisp={this.props.dispornodisp}
              title={twt.u1.title}
              ...
              likes={twt.u1.likes}
              bgimg={twt.u1.bgimg}
              twthandle={twt.u1.twthandle}
              twt={twt.u1.twt}
              flwing={twt.u1.flwing}
              flwers={twt.u1.flwers}
            />
          </div>
          <div className="user">
            <Tweets
              ...
              likes={twt.u2.likes}
              bgimg={twt.u2.bgimg}
              twthandle={twt.u2.twthandle}
              twt={twt.u2.twt}
              flwing={twt.u2.flwing}
              flwers={twt.u2.flwers}
            />
          </div>
          <div className="user">
            <Tweets
              ...
              likes={twt.u3.likes}
              bgimg={twt.u3.bgimg}
              twthandle={twt.u3.twthandle}
              twt={twt.u3.twt}
              flwing={twt.u3.flwing}
              flwers={twt.u3.flwers}
            />
          </div>
          <div className="user">
            <Tweets
              ...
              likes={twt.u4.likes}
              bgimg={twt.u4.bgimg}
              twthandle={twt.u4.twthandle}
              twt={twt.u4.twt}
              flwing={twt.u4.flwing}
              flwers={twt.u4.flwers}
            />
          </div>
        </Paper>
      </div>
