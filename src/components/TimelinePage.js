    ...
    render(){
        return(
            <div>
                ...
                <ProfileCard className={my.mypro.className} bgimg={my.mypro.bgimg} avaimg={my.mypro.avaimg} name={my.mypro.name}
                twthandle={my.mypro.twthandle} twt={my.mypro.twt} flwing={my.mypro.flwing} flwers={my.mypro.flwers} />
