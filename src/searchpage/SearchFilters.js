    ...
    render(){
        return(
            <div id="searchfilterdiv">
                ...
                <h3>Search filters<span id="dropfilterlist">Show</span></h3>
                <div id="filtertypes">
                    <div id="peopledrop">
                    <DropDownMenu value={this.state.value} 
                     style={styles.customWidth}  autoWidth={false} >
                    <MenuItem value={1} primaryText="From anyone" />
                    <MenuItem value={2} primaryText="People you follow" />                    
                    </DropDownMenu>
                    </div>
                    <div id="placedrop">
                    <DropDownMenu style={styles.customWidth} autoWidth={false}
                    ...
                    <a href="/"><h5>Advanced search</h5></a>
                </div>
                </Paper>
            </div>
        );
