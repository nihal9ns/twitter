    ...
    render(){
        return(
            <div className="searchtweetfeedsdiv" >
                ...
                <div className="user">                
                    <Tweets  title={twt.u1.title} subtitle={twt.u1.subtitle} avatar={twt.u1.avatar} 
                    imgsrc={twt.u1.imgsrc} replies={twt.u1.replies} retweets={twt.u1.retweets} likes={twt.u1.likes} />
                </div>
                <div className="user">
                    <Tweets  title={twt.u2.title} subtitle={twt.u2.subtitle} avatar={twt.u2.avatar} 
                    imgsrc={twt.u2.imgsrc} replies={twt.u2.replies} retweets={twt.u2.retweets} likes={twt.u2.likes}  />
                </div>
                <div className="user">    
                    <Tweets  title={twt.u3.title} subtitle={twt.u3.subtitle} avatar={twt.u3.avatar} 
                    imgsrc={twt.u3.imgsrc} replies={twt.u3.replies} retweets={twt.u3.retweets} likes={twt.u3.likes}  />
                </div>
                <div className="user">    
                    <Tweets  title={twt.u4.title} subtitle={twt.u4.subtitle} avatar={twt.u4.avatar}
                    imgsrc={twt.u4.imgsrc} replies={twt.u4.replies} retweets={twt.u4.retweets} likes={twt.u4.likes}  />
                </div>
                </Paper>
            </div>
        );
